...
try {
  ...
  return (
    ...
    <textarea type="text" className={`form-control my-2 text-${props.Mode==='light'?'dark':'light'} bg-${props.Mode==='light'?'light':'dark'}`} id="input" name="input" value={cred.input} onChange={echange}/>
    <label htmlFor="exampleInputPassword1" className={`form-label text-${props.Mode==='light'?'dark':'light'}`}>Translated Text</label>
    <textarea type="text" readOnly className={`form-control my-2 text-${props.Mode==='light'?'dark':'light'} bg-${props.Mode==='light'?'light':'dark'}`} id="amount" name="amount" value={cred.amount} onChange={echange}/>
    ...
    <input type="text" readOnly className={`form-control text-${props.Mode==='light'?'dark':'light'} bg-${props.Mode==='light'?'light':'dark'}`} id="lan" name="lan" value={cred.lan} onChange={echange}/>
  </div>
  ...
  <p className={`text-${props.Mode==='light'?'dark':'light'}`}>Translate Text of Known Language?
</p>
<button className={`btn btn-outline-${props.Mode==='light'?'success':'info'}`} onClick={()=>{settrans(true);}}>Click Here</button>
  ...
  <p className={`text-${props.Mode==='light'?'dark':'light'} my-2`}>Translate Text of Unknown Language?
</p>
