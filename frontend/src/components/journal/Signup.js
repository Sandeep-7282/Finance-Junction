...
const echange=(e)=>{
  ...
  <div className="mb-3">
    ...
    <input type="text" className={`form-control text-${props.Mode==='light'?'dark':'light'} bg-${props.Mode==='light'?'light':'dark'}`} id="name" name="name" value={cred.name} minLength={3} onChange={echange}aria-describedby="emailHelp"/>
  </div>
  <div className="mb-3">
  ...
  <div className="mb-3">
    ...
    <input type="password" className={`form-control text-${props.Mode==='light'?'dark':'light'} bg-${props.Mode==='light'?'light':'dark'}`} id="password" name="password" value={cred.password} minLength={4} onChange={echange}/>
  </div>
  <div className="mb-3">
